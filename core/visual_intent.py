...
TABLEAU_TO_PBI_MAP: Dict[str, dict] = {
    ...
    "map": {"pbi_type": "tableEx", "fidelity": "approximate",
            "note": "Map visuals require Bing Maps tenant config. Falls back to table."},
    "filled-map": {"pbi_type": "tableEx", "fidelity": "approximate",
                   "note": "Filled map requires Bing Maps tenant config. Falls back to table."},
    ...
    "multipolygon": {"pbi_type": "tableEx", "fidelity": "approximate",
                     "note": "Polygon visuals require Bing Maps tenant config. Falls back to table."},
    "polygon": {"pbi_type": "tableEx", "fidelity": "approximate",
                "note": "Polygon visuals require Bing Maps tenant config. Falls back to table."},
